 ...
 */
function detectarNivelEscolar(serie) {
 ...
 */
function validarHabilidadeNivel(codigo, nivelEscolar) {
 ...
 */
function filtrarNodesPorRelevancia(nodes, tema, disciplina, serie) {
 ...
 */
function extrairHabilidadesBNCC(nodes, nivelEscolar) {
 ...
 */
async function consultarBNCCMultiplasQueries(tema, disciplina, serie, anoSerie, engine) {
    const nivelEscolar = detectarNivelEscolar(serie);
 ...
 */
app.post("/api/gerar-contexto", async (req, res) => {
    try {
        ...
        const bnccResponse = await consultarBNCCMultiplasQueries(tema, disciplina, serie, anoSerie, engine);
        ...
        if (bnccResponse.habilidades && bnccResponse.habilidades.length > 0) {
            const habilidadesValidas = bnccResponse.habilidades.filter((h) => validarHabilidadeNivel(h.codigo, nivelEscolar));
        ...
        if (bnccResponse.habilidades && bnccResponse.habilidades.length > 0) {
            ...
            bnccResponse.habilidades.forEach((h) => {
